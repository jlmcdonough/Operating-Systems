...
(function (TSOS) {
    class Shell {
        ...
        init() {
            ...
            this.commandList[this.commandList.length] = sc;
            // rename
            sc = new TSOS.ShellCommand(this.shellRename, "rename", "<oldfilename> <newfilename> - Renames a file");
            this.commandList[this.commandList.length] = sc;
            // copy
            sc = new TSOS.ShellCommand(this.shellCopy, "copy", "<oldfilename> <newfilename> - copies a file");
            this.commandList[this.commandList.length] = sc;
